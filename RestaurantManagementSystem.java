...
public class RestaurantManagementSystem {
    public static void main(String args[]) {
        ...
        } while (!choice1.equalsIgnoreCase("E")); // Loop continues until user enters "E".
        // --- END : Main Program Loop ---

        // --- START: Bill Calculation and Display ---

        // 1. Calculation total food cost
        tot = tamt + tamt1 + tamt2;

        // 2.Calculation GST at 18.0%
        gst = tot * 18.0 / 100.0;
        ...
        // Display individual section totals
        System.out.println("********** Starters **********");
        System.out.printf("Total cost of starters = Rs. %.2f%n", tamt);

        System.out.println("********** Main Course **********");
        System.out.printf("Total cost of main course = Rs. %.2f%n", tamt1);

        System.out.println("********** Desserts **********");
        System.out.printf("Total cost of Desserts = Rs. %.2f%n", tamt2);

        // Display final bill components
        System.out.println("-----------------------------------------------------------------");
        System.out.printf("Total food cost (before GST) = Rs. %2f%n", tot);
        System.out.printf("GST (@18.0%%) = Rs. %.2f%n", gst);
        System.out.println("-----------------------------------------------------------------");
        System.out.printf("Amount to be paid = Rs. %.2f%n", gtotal);
        System.out.println("------------------------------------------------------------------");
